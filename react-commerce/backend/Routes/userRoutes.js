...
router.get("/checkemail/:email",RouteCheckAuth , AdminUserController.checkEmail);
router.get("/checkmobile/:mobile",RouteCheckAuth , AdminUserController.Mobile);
router.get("/UniqueID/:unique_id",RouteCheckAuth , AdminUserController.checkUniqeID);
router.post("/passwordforgot/:email",RouteCheckAuth , AdminUserController.forgotPassword);
