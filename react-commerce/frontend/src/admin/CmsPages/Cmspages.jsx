...
const Cmspages = () => {
  ...
  const fetchCmsPages = async () => {
    ...
    setLoading(true);
    try {
      const response = await axios.get(`${BASE_URL}/api/getAllCmss`, {
        params: { page, limit },
  ...
  const searchFunction = useCallback(
    debounce((searchTerm) => {
      ...
      const filteredData = cmspagedata.filter(
        (item) =>
    ...
    [cmspagedata]
  ); // Dependencies: search function only recreated if cmspagedata changes
