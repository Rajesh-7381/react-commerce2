      ...
      <div className="container">
        ...
        <div className="primary-nav">
          ...
          <a className="main-logo" href="index.html">
            <img src="./frontend/images/logo/logo-1.png" alt="" />
          </a>
          {/*====== End - Main Logo ======*/}
          {/*====== Search Form ======*/}
                            ...
                            <div className="mega-banner">
                              ...
                              >
                                <img
                                  ...
                                  src="./frontend/images/banners/sitemaker-slider-banner-1.png"
                                  alt=""
                                />
                              </a>
                            </div>
          ...
          <div className="menu-init" id="navigation3">
            ...
            <div className="ah-lg-mode">
              ...
              <ul className="ah-list ah-list--design1 ah-list--link-color-secondary">
                <li>
                  <a href="index.html">
                    <i className="fas fa-home u-c-brand" />
                  </a>
                </li>
                <li>
                ...
                <li className="has-dropdown">
                  <a className="mini-cart-shop-link">
                    ...
                    <span className="total-item-round">3</span>
                  </a>
                  {/*====== Dropdown ======*/}
                  <span className="js-menu-toggle" />
                          ...
                          <div className="mini-product__image-wrapper">
                            ...
                            >
                              <img
                                ...
                                src="./frontend/images/product/sitemakers-tshirt.png"
                                alt=""
                              />
                            </a>
                          </div>
                        ...
                        <div className="mini-product">
                          <div className="mini-product__image-wrapper">
                            ...
                            >
                              <img
                                className="u-img-fluid"
                                src="images/product/sitemakers-tshirt.png"
                                alt=""
                              />
                            </a>
                          </div>
